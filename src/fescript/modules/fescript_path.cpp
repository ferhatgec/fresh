...
__idk_nodiscard Object FescriptPathExists::call([[maybe_unused]] Interpreter& interpreter, const std::vector<Object>& arguments) {
...
__idk_nodiscard Object FescriptPathIsDir::call([[maybe_unused]] Interpreter& interpreter, const std::vector<Object>& arguments) {
...
__idk_nodiscard Object FescriptPathIsFile::call([[maybe_unused]] Interpreter& interpreter, const std::vector<Object>& arguments) {
...
__idk_nodiscard Object FescriptPathIsSymlink::call([[maybe_unused]] Interpreter& interpreter, const std::vector<Object>& arguments) {
...
__idk_nodiscard Object FescriptPathIsSocket::call([[maybe_unused]] Interpreter& interpreter, const std::vector<Object>& arguments) {
...
__idk_nodiscard Object FescriptPathIsEmpty::call([[maybe_unused]] Interpreter& interpreter, const std::vector<Object>& arguments) {
...
__idk_nodiscard Object FescriptPathCwd::call([[maybe_unused]] Interpreter& interpreter, const std::vector<Object>& arguments) {
  return std::filesystem::current_path().filename().string();
}

__idk_nodiscard Object FescriptPathRwalk::call([[maybe_unused]] Interpreter& interpreter, const std::vector<Object>& arguments) {
...
__idk_nodiscard Object FescriptPathWalk::call([[maybe_unused]] Interpreter& interpreter, const std::vector<Object>& arguments) {
