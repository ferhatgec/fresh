...
namespace fescript {
__idk_nodiscard Object FescriptPolygonObjectMemberPushPolygon::call(Interpreter& interpreter, std::vector<Object> arguments) {
...
__idk_nodiscard Object FescriptPolygonObjectMemberDeleteAllPolygons::call(fescript::Interpreter& interpreter, std::vector<Object> arguments) {
  this->_self->get_polygon_resource().delete_all_polygons();
  return this->_self->get_polygon_resource().get_polygons().empty();
}

__idk_nodiscard Object FescriptPolygonObjectMemberGetIsFilled::call(fescript::Interpreter& interpreter, std::vector<Object> arguments) {
...
[[nodiscard]] Object PolygonObjectWrapper::call(Interpreter &interpreter, std::vector<Object> arguments) {
