...
private:
  ...
  std::shared_ptr<fresh::SpriteObject> _icon;
  std::shared_ptr<fresh::LabelObject> _font;
  std::shared_ptr<fresh::SpriteObject> _test;
  std::shared_ptr<fresh::SpriteObject> _test2;
  std::shared_ptr<fresh::SpriteObject> _test3;


  std::shared_ptr<fresh::CameraObject> _camera_object;

  std::shared_ptr<fresh::AreaObject> _collision_detection_1;
  std::shared_ptr<fresh::AreaObject> _collision_detection_2;

  std::shared_ptr<fresh::CollisionObject> _collision_obj;
  ...
  std::shared_ptr<fresh::SpriteObject> character_sprite_1;
  std::shared_ptr<fresh::SpriteObject> character_sprite_2;
  std::shared_ptr<fresh::SpriteObject> character_sprite_3;
  std::shared_ptr<fresh::SpriteObject> character_sprite_4;
  std::shared_ptr<fresh::SpriteObject> character_sprite_5;
...
public:
  Application() {
    ...
    _collision_detection_1 = std::make_shared<fresh::AreaObject>();
    _collision_detection_2 = std::make_shared<fresh::AreaObject>();
    ...
    _collision_obj = std::make_shared<fresh::CollisionObject>();
    ...
    _font = std::make_shared<fresh::LabelObject>();
    ...
    _font->initialize_text("red font test", SDL_Color {
                                             .r = 255,
                                             .g = 0,
                                             .b = 0,
                                             .a = 255 // ~0.5
    ...
    character_sprite_1 = std::make_shared<fresh::SpriteObject>();
    ...
    character_sprite_2 = std::make_shared<fresh::SpriteObject>();
    ...
    character_sprite_3 = std::make_shared<fresh::SpriteObject>();
    ...
    character_sprite_4 = std::make_shared<fresh::SpriteObject>();
    ...
    character_sprite_5 = std::make_shared<fresh::SpriteObject>();
    ...
    _test = std::make_shared<fresh::SpriteObject>();
    ...
    _test2 = std::make_shared<fresh::SpriteObject>();
    ...
    _test3 = std::make_shared<fresh::SpriteObject>();
    ...
    _camera_object = std::make_shared<fresh::CameraObject>();
    ...
    _icon->push_object(_camera_object);

    Engine::get_instance()->push_object(_icon); // index 0 -> sync with get_index_in_render_objects() for fast access.
    Engine::get_instance()->push_object(_font);
